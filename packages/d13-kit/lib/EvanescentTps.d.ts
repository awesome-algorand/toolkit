...
/**
 * The argument types for the EvanescentTps contract
 */
export type EvanescentTpsArgs = {
    /**
 ...
 */
export type EvanescentTpsReturns = {};
/**
 * Defines the types of available calls and state of the EvanescentTps smart contract.
 */
export type EvanescentTpsTypes = {
    /**
 ...
 */
export type EvanescentTpsSignatures = keyof EvanescentTpsTypes['methods'];
/**
 * Defines the possible abi call signatures for methods that return a non-void value.
 */
export type EvanescentTpsNonVoidMethodSignatures = keyof EvanescentTpsTypes['methods'] extends infer T ? T extends keyof EvanescentTpsTypes['methods'] ? MethodReturn<T> extends void ? never : T : never : never;
/**
...
/**
 * Maps a method signature from the EvanescentTps smart contract to the method's arguments in either tuple or struct form
 */
export type MethodArgs<TSignature extends EvanescentTpsSignatures> = EvanescentTpsTypes['methods'][TSignature]['argsObj' | 'argsTuple'];
/**
 * Maps a method signature from the EvanescentTps smart contract to the method's return type
 */
export type MethodReturn<TSignature extends EvanescentTpsSignatures> = EvanescentTpsTypes['methods'][TSignature]['returns'];
/**
 * Defines supported create method params for this smart contract
 */
export type EvanescentTpsCreateCallParams = Expand<AppClientBareCallParams & {
    method?: never;
} & {
 ...
 */
export type EvanescentTpsDeployParams = Expand<Omit<AppFactoryDeployParams, 'createParams' | 'updateParams' | 'deleteParams'> & {
    /**
     * Create transaction parameters to use if a create needs to be issued as part of deployment; use `method` to define ABI call (if available) or leave out for a bare call (if available)
     */
    createParams?: EvanescentTpsCreateCallParams;
}>;
/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the EvanescentTps smart contract
 */
export declare abstract class EvanescentTpsParamsFactory {
}
/**
 ...
 */
export declare class EvanescentTpsFactory {
    /**
     ...
     */
    getAppClientById(params: AppFactoryAppClientParams): EvanescentTpsClient;
    /**
     ...
     * @returns The `AppClient`
     */
    getAppClientByCreatorAndName(params: AppFactoryResolveAppClientByCreatorAndNameParams): Promise<EvanescentTpsClient>;
    /**
     ...
     */
    deploy(params?: EvanescentTpsDeployParams): Promise<{
        result: {
 ...
 */
export declare class EvanescentTpsClient {
    /**
     * The underlying `AppClient` for when you want to have more flexibility
     */
    readonly appClient: _AppClient;
    /**
     * Creates a new instance of `EvanescentTpsClient`
     *
     * @param appClient An `AppClient` instance which has been created with the EvanescentTps app spec
     */
     ...
     */
    decodeReturnValue<TSignature extends EvanescentTpsNonVoidMethodSignatures>(method: TSignature, returnValue: ABIReturn | undefined): undefined;
    /**
     * Returns a new `EvanescentTpsClient` client, resolving the app by creator address and name
     * using AlgoKit app deployment semantics (i.e. looking for the app creation transaction note).
     * @param params The parameters to create the app client
     */
    static fromCreatorAndName(params: Omit<ResolveAppClientByCreatorAndName, 'appSpec'>): Promise<EvanescentTpsClient>;
    /**
     ...
     * @param params The parameters to create the app client
     */
    static fromNetwork(params: Omit<ResolveAppClientByNetwork, 'appSpec'>): Promise<EvanescentTpsClient>;
     ...
     */
    clone(params: CloneAppClientParams): EvanescentTpsClient;
    /**
     * Methods to access state for the current EvanescentTps app
     */
    state: {};
    newGroup(): EvanescentTpsComposer;
}
export type EvanescentTpsComposer<TReturns extends [...any[]] = []> = {
    /**
     * Makes a clear_state call to an existing instance of the EvanescentTps smart contract.
     *
     ...
     */
    clearState(params?: AppClientBareCallParams): EvanescentTpsComposer<[...TReturns, undefined]>;
    /**
     ...
     */
    addTransaction(txn: Transaction, signer?: TransactionSigner): EvanescentTpsComposer<TReturns>;
    /**
     ...
     */
    simulate(): Promise<EvanescentTpsComposerResults<TReturns> & {
        simulateResponse: SimulateResponse;
    }>;
    simulate(options: SkipSignaturesSimulateOptions): Promise<EvanescentTpsComposerResults<TReturns> & {
        simulateResponse: SimulateResponse;
    }>;
    simulate(options: RawSimulateOptions): Promise<EvanescentTpsComposerResults<TReturns> & {
        simulateResponse: SimulateResponse;
    }>;
    /**
     * Sends the transaction group to the network and returns the results
     */
    send(params?: SendParams): Promise<EvanescentTpsComposerResults<TReturns>>;
};
export type EvanescentTpsComposerResults<TReturns extends [...any[]]> = Expand<SendAtomicTransactionComposerResults & {
    returns: TReturns;
}>;
